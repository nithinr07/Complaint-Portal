...
class ComplaintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create complaint" do
    assert_difference('Complaint.count') do
      post complaints_url, params: { complaint: { description: @complaint.description, status: @complaint.status, subject: @complaint.subject, tag_id: @complaint.tag_id, user_id: @complaint.user_id } }
    end
  ...
  test "should update complaint" do
    patch complaint_url(@complaint), params: { complaint: { description: @complaint.description, status: @complaint.status, subject: @complaint.subject, tag_id: @complaint.tag_id, user_id: @complaint.user_id } }
